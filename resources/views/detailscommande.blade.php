        ...
        <table class="border border-1 border-black text-left min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
            ...
            <tbody class="divide-y divide-gray-200">
                @foreach($produits as $produit)
                    <tr data-href="{{ route('produit', ['variantecouleurproduit' => $produit->idvariantecouleurproduit, 'selectTaille' => $produit->idtailleproduit]) }}" class="hover:cursor-pointer hover:bg-gray-50">
                        <td></td>
