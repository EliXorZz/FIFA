...
<ul class="flex flex-col gap-5 px-20 py-10">
    ...
    @foreach($themevotes as $themevote)
        <a href={{ route('selectedtheme', ['id' => $themevote->idthemevote]) }}>
            <li class="border-2 border-black p-8">{{$themevote->titrethemevote}}
